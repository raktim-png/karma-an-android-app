...
public class CategoryElectrician extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_electrician);

        rv = findViewById(R.id.rv_electrician);
    ...
    private void EventChangeListener() {
        ...
        db.collection("Electrician").addSnapshotListener((value, error) -> {
            assert value != null;
