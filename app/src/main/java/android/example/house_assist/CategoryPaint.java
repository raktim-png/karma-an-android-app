...
public class CategoryPaint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_paint);

        rv = findViewById(R.id.rv_paint);
    ...
    private void EventChangeListener() {
        ...
        db.collection("Painting").addSnapshotListener((value, error) -> {
            assert value != null;
