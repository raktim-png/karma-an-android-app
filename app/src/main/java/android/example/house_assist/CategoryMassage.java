...
public class CategoryMassage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_massage);

        rv = findViewById(R.id.rv_massage);
    ...
    private void EventChangeListener() {
        ...
        db.collection("Massage").addSnapshotListener((value, error) -> {
            assert value != null;
