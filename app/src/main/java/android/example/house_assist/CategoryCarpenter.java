...
public class CategoryCarpenter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_carpenter);

        rv = findViewById(R.id.rv_carpenter);
    ...
    private void EventChangeListener() {
        ...
        db.collection("Carpenter").addSnapshotListener((value, error) -> {
            assert value != null;
