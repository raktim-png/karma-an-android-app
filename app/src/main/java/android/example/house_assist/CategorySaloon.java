...
public class CategorySaloon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_saloon);

        rv = findViewById(R.id.rv_saloon);
    ...
    private void EventChangeListener() {
        ...
        db.collection("Salon").addSnapshotListener((value, error) -> {
            assert value != null;
